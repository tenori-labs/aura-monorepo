...
import { Box, Button, Card, Flex, Heading, Text, TextField, Checkbox, Separator } from "@radix-ui/themes";
    ...
    return (
        <Card size="4" style={{ maxWidth: "800px", margin: "0 auto" }}>
            <Flex direction="column" gap="5">
                ...
                {/* Student Information */}
                <Box>
                    <Heading size="4" mb="3">Student Information</Heading>
                    <Flex direction="column" gap="3">
                        <Flex gap="2">
                            <Text weight="bold" style={{ width: "120px" }}>Name:</Text>
                            <Text>{fullName}</Text>
                        </Flex>
                        {studentId && (
                            <Flex gap="2">
                                <Text weight="bold" style={{ width: "120px" }}>Student ID:</Text>
                                <Text>{studentId}</Text>
                            </Flex>
                        )}
                        {course && (
                            <Flex gap="2">
                                <Text weight="bold" style={{ width: "120px" }}>Course:</Text>
                                <Text>{course}</Text>
                            </Flex>
                        )}
                    </Flex>
                ...
                {/* Declaration Text */}
                <Box>
                    <Heading size="4" mb="4" align="center">UNDERTAKING FROM THE STUDENT</Heading>

                    <Flex direction="column" gap="4">
                        <Text as="p" size="2" style={{ lineHeight: 1.6 }}>
                            1) I, <Text weight="bold">{fullName}</Text>{studentId ? `, with Student ID ${studentId}` : ""}, have received and carefully read the UGC Regulations on Curbing the Menace of Ragging in Higher Educational Institutions, 2009, (hereinafter called the “Regulations”).
                        </Text>
                        <Text as="p" size="2" style={{ lineHeight: 1.6 }}>
                        ...
                        <Text as="p" size="2" style={{ lineHeight: 1.6 }}>
                            ...
                            <br />&nbsp;&nbsp;&nbsp;&nbsp;a) I will not indulge in any behavior or act that may be constituted as ragging under clause 3 of the Regulations.
                            <br />&nbsp;&nbsp;&nbsp;&nbsp;b) I will not participate in or abet or propagate through any act of commission or omission that may be constituted as ragging under clause 3 of the Regulations.
                        </Text>
                        <Text as="p" size="2" style={{ lineHeight: 1.6 }}>
                ...
                {/* Checkboxes */}
                <Flex direction="column" gap="3">
                    <Text as="label" size="2" style={{ cursor: "pointer", display: "flex", gap: "8px", alignItems: "start" }}>
                    ...
                    <Text as="label" size="2" style={{ cursor: "pointer", display: "flex", gap: "8px", alignItems: "start" }}>
                        <Checkbox checked={agreedParent} onCheckedChange={(c) => setAgreedParent(!!c)} />
                        I confirm that my parent/guardian has also read and understood this undertaking. (A separate undertaking from your parent/guardian may be required by the institution).
                    </Text>
                </Flex>
                ...
                <Box>
                    ...
                    <Text as="p" size="2" color="gray" mb="3">
                        Please type your full name in the box below to digitally sign this undertaking. Your typed name will be considered your legal signature for this document.
                    </Text>
