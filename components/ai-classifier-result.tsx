...
export function AiClassifierResult({ result }: { result: AiResult }) {
    ...
    const validityColor =
        result.validity === "Likely Valid" ? "green" :
            result.validity === "Needs Review" ? "orange" : "red";
        ...
        <Flex direction="column" gap="4">
            ...
            <Box mt="2">
                <Flex justify="between" mb="1" align="end">
                    <Text size="1" weight="medium" color="gray">AI Confidence</Text>
                    <Text size="1" weight="bold">{confidencePercent}%</Text>
                </Flex>
