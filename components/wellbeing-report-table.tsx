...
import { EyeOpenIcon, Share1Icon, CheckCircledIcon } from '@radix-ui/react-icons';
import {
  revealIdentity,
  updateReportStatus,
  generateCounselorReport,
} from '@/app/wellbeing/wellbeing-actions';
              ...
              >
                <Dialog.Title mb="1">
                  <Text size={{ initial: '3', sm: '5' }}>
                    Wellbeing Report:{' '}
                    <Text style={{ fontFamily: 'monospace' }}>{selected.caseId}</Text>
                  </Text>
                </Dialog.Title>
                <Flex justify="between" align="center" mt="2" wrap="wrap" gap="2">
                  <Flex gap="2" align="center">
                    ...
                    {selected.riskLevel && (
                      <Badge
                        color={getRiskColor(selected.riskLevel)}
                        size="2"
                        variant="solid"
                        style={{ textTransform: 'capitalize' }}
                      >
              ...
              >
                      ...
                      <Flex direction="column" gap="2" py="1">
                        {selected.observedBehaviors.map((b, i) => (
                          <Flex key={i} gap="2" align="start">
                            <Text size="2" color="gray" style={{ flexShrink: 0, marginTop: 2 }}>
                              •
                            </Text>
                ...
                <Box mb="4">
                  ...
                  <Flex gap="2" wrap="wrap">
                    {selected.themes.map((t) => (
                      <Badge key={t} size="2" variant="surface" color="gray">
                        {t}
                      </Badge>
                    ))}
                  </Flex>
                ...
                {!hasStructuredData(selected) && (
                  <Box
                    mb="4"
                    p="3"
                    style={{ background: 'var(--gray-a3)', borderRadius: 'var(--radius-3)' }}
                  >
                    ...
                    >
                      <Flex direction="column" gap="3">
                        ...
                        <Flex gap="4" wrap="wrap">
                          ...
                          <Text size="1" color="gray">
                            Date: <Text weight="medium">{formatDate(selected.generatedAt)}</Text>
                          </Text>
                        </Flex>
                        ...
                        {selected.observedBehaviors && selected.observedBehaviors.length > 0 && (
                          <Box>
                            ...
                            <Flex direction="column" gap="1">
                              {selected.observedBehaviors.map((b, i) => (
                                <Text key={i} size="2" style={{ lineHeight: 1.5 }}>
                                  • {b}
                                </Text>
                              ))}
                            </Flex>
                        ...
                        <Flex justify="between" align="center" wrap="wrap" gap="2">
                          <Text
                            size="1"
                            color="gray"
                            style={{ fontStyle: 'italic', maxWidth: 350 }}
                          >
                            No diagnostic claims are made. Use this context to guide initial
                            outreach.
                          </Text>
