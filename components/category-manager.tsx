        ...
        return (
            <Card size="2">
                <Flex align="center" justify="center" py="5">
                    <Text size="2" color="gray">Loading category assignments...</Text>
                </Flex>
            </Card>
        );
    }
                        ...
                        <Table.Body>
                            {categories.map((cat) => (
                                <Table.Row key={cat.category}>
                                    <Table.Cell>
                                        <Text size="2" weight="medium">{cat.category}</Text>
                                    </Table.Cell>
                                    <Table.Cell>
                                        {cat.facultyEmail ? (
                    ...
                    <Card key={cat.category} size="2">
                        <Flex direction="column" gap="2">
                            <Flex justify="between" align="center" gap="2">
                                ...
                                {cat.facultyEmail ? (
                                    <Badge variant="soft" color="green" size="1">Assigned</Badge>
                                ) : (
                                    <Badge variant="soft" color="gray" size="1">Unassigned</Badge>
                                )}
                            </Flex>
