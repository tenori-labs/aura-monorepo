...
export default function ReportIncidentPage() {
    ...
    const [state, formAction, isPending] = useActionState(submitIncident as any, initialState);
    const [isDialogOpen, setIsDialogOpen] = useState(false); // Added isDialogOpen state

    // Open dialog when AI analysis is received
    useEffect(() => {
        if (state.aiAnalysis) {
                ...
                <Flex direction="column" gap="4">
                    ...
                    <Dialog.Root open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        <Dialog.Content style={{ maxWidth: 450 }}>
                            ...
                            {state.aiAnalysis && (
                                <AiClassifierResult result={state.aiAnalysis} />
                            )}
                        ...
                        <Flex direction="column" gap="5">
                            <Box>
                                ...
                                <Text size="2" color="gray">
                                    Your report is important. Please provide accurate
                                    and detailed information. You can choose to
                                    remain anonymous.
                                </Text>
                            </Box>
                            ...
                            <form action={formAction}>
                                <Flex direction="column" gap="5">
                                    ...
                                    <Box>
                                        ...
                                        />
                                        <Text size="1" color="gray" mt="1">
                                            If provided, it will only be used for
