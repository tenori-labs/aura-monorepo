...
import { Container, Flex, Heading, Text, Card, Badge, Button, Separator, Box } from "@radix-ui/themes";
...
export default async function ConsentFormPage() {
    ...
    return (
        ...
        >
            <PageHeader
                title="Consent Form"
                subtitle="UGC Anti-Ragging Undertaking"
                userRole={role}
            />
            ...
            <Container p="4" style={{ flex: 1, maxWidth: "900px", margin: "0 auto", width: "100%" }}>
                {existingConsent ? (
                    ...
                    <Flex direction="column" gap="4">
                        {/* Success Banner */}
                        <Card size="3">
                            <Flex direction="column" align="center" gap="3" py={{ initial: "4", sm: "6" }} px={{ initial: "3", sm: "5" }}>
                                <Box style={{
                                    width: "72px", height: "72px", borderRadius: "50%",
                                    background: "var(--green-a3)", display: "flex",
                            ...
                            <Flex direction="column" gap="4" p={{ initial: "2", sm: "3" }}>
                                ...
                                <Box style={{
                                    ...
                                    <Flex direction="column" gap="1">
                                        ...
                                        <Text size="3" weight="bold">{existingConsent.fullName}</Text>
                                    </Flex>
