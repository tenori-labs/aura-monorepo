...
/**
 * Refresh Supabase session cookies and strictly protect role-based routing.
 * Must be executed within Next.js Middleware. Includes redirect logic for admins and faculty.
 *
 * @param request - The incoming Next.js routing request
 * @returns The Next.js response allowing access, redirecting, or refreshing cookies appropriately
 */
export async function updateSession(request: NextRequest) {
  ...
  if (!user && ALL_PROTECTED_ROUTES.some((route) => pathname.startsWith(route))) {
