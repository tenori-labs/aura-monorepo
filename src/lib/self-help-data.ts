...
Bring your attention to your body. Notice the points of contact with the chair or floor. Let go of any tightness you might be holding.
Now, shift your focus to your breath. Don't try to change it; just observe its natural rhythm. Notice the sensation of the air entering your nostrils and filling your lungs.
If your mind wanders, that's completely normal. Gently guide your attention back to your breath without judgment.
Continue this for a few more moments, simply being present with your breath.
When you're ready, slowly bring your awareness back to the room. Wiggle your fingers and toes. Gently open your eyes.
    `,
  },
  {
    id: 'i1',
...
4.  **Take a short break** of 5 minutes. Stretch, get some water, or do something non-work-related.
5.  **After four Pomodoros**, take a longer break of 15-30 minutes.

This method helps to maintain high levels of focus and prevent mental fatigue, making your study sessions more effective.
    `,
  },
  {
    id: 'v3',
...
- **Break Down Large Projects:** Divide large assignments into smaller, manageable steps to avoid feeling overwhelmed.
- **Schedule Your Study Time:** Treat study sessions like appointments you can't miss.
- **Avoid Multitasking:** Focus on one thing at a time for better quality work.
...
(This is a placeholder for an audio player which could be implemented in a future version.)
    `,
  },
  {
    id: 'a2',
...
- **Hydrate:** Start your day with a glass of water before anything else.
- **Avoid Your Phone:** Give yourself at least 15-30 minutes before checking emails or social media.
- **Move Your Body:** Gentle stretching, a short walk, or a quick workout can wake you up.
- **Eat a Healthy Breakfast:** Fuel your brain for the day ahead.
- **Plan Your Day:** Briefly review your schedule and set your top three priorities.
...
Poses include:
- **Cat-Cow:** To warm up the spine and link breath to movement.
- **Child's Pose:** A resting pose to release tension in the back and shoulders.
- **Downward-Facing Dog:** To gently stretch the entire body.
- **Forward Fold:** To release the spine and calm the mind.
- **Seated Meditation:** To finish the practice with a few moments of quiet reflection.
Remember to move at your own pace and listen to your body.
    `,
  },
  {
    id: 's2',
...
6. Repeat this cycle for 1-3 minutes.
This technique, known as box breathing or 4-4-6 breathing, can help regulate your nervous system and bring a sense of calm.
...
Boundaries are the limits we set for ourselves within relationships. They can be physical (e.g., personal space, touch), emotional (e.g., not taking on others' feelings), or digital (e.g., response times to messages).
**2. How to Identify Your Boundaries**
Pay attention to your feelings. Discomfort, resentment, or stress can be signs that a boundary is being crossed.
**3. How to Communicate Boundaries**
...
**2. Be Direct (If Safe):** If you feel safe and comfortable doing so, you can tell the person directly to stop. "Please stop contacting me" or "That comment is inappropriate" are clear statements.
**3. Document Everything:** Keep a record of dates, times, locations, and what happened. Save screenshots of messages or emails. This is crucial if you decide to report the behavior.
...
- **Know Your Limits:** If you choose to drink, understand how alcohol affects you. Factors like body weight, food intake, medications, and personal tolerance all play a role. Pacing yourself is key.
- **It's Okay to Say No:** Never feel pressured to drink or use substances. Your friends should respect your decision. It's always a good idea to have a non-alcoholic drink in your hand if it makes you feel more comfortable.

### Practical Safety Strategies
- **The Buddy System:** Stay with a group of friends you trust. Agree to arrive together, check in on each other throughout the event, and leave together. Never leave a friend behind, especially if they are intoxicated.
- **Never Leave Your Drink Unattended:** This is a critical safety measure to prevent someone from adding something to your drink without your knowledge. If you lose sight of your drink, get a new one.
- **Charge Your Phone:** Make sure your phone is fully charged before you go out, so you can contact friends or arrange for a safe ride home.

### Consent and Awareness
- **Consent is Clear, Coherent, and Ongoing:** Alcohol and other substances impair judgment. Someone who is intoxicated cannot legally or ethically give consent. Only a clear and enthusiastic "yes" means yes.
- **Be an Active Bystander:** If you see someone who looks like they are in trouble, being pressured, or is too intoxicated to take care of themselves, step in. You can create a distraction, ask them directly if they are okay, or find a host or RA to help.

### Recognizing and Responding to Emergencies
- **Know the Signs of Alcohol Poisoning:** These include confusion, vomiting, seizures, slow or irregular breathing, and pale or bluish skin.
