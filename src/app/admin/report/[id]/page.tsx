...
const getCategoryIcon = (category: string) => {
  switch (category.toLowerCase()) {
    ...
    case 'theft':
      return <HandCoins className="h-5 w-5 text-yellow-500" />;
    case 'vandalism':
...
const getDummyReportById = (id: string): Report | undefined => {
  ...
  if (numericIdPart % 4 === 0) {
    ...
    if (numericIdPart % 2 === 0) {
      // Add faculty notes for some assigned reports
        ...
        <CardFooter className="bg-muted/30 p-6 flex flex-col sm:flex-row sm:justify-around sm:items-center gap-4">
            ...
            <Dialog open={isAssignDialogOpen} onOpenChange={setIsAssignDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Select a faculty member to assign this incident report to. Current:{' '}
          ...
          <div className="flex flex-col items-center text-center w-full sm:w-auto">
            ...
            <p className="text-xs text-muted-foreground mt-1 max-w-xs">
              This will download a PDF of the case report with timeline that can be submitted to
              legal and police team.
            </p>
          </div>
