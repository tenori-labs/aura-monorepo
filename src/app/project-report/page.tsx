...
import { FileText, LogIn, LayoutDashboard, FilePlus2, Smile, BookHeart, FileSignature, ShieldCheck, Briefcase, HeartHandshake, HelpCircle } from "lucide-react";

// Helper component for consistent section styling
const ReportSection = ({ icon, title, description, features, roles }: { icon: React.ReactNode, title: string, description: string, features: string[], roles: string[] }) => (
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 bg-background text-foreground font-sans">
      <header className="text-center mb-10 border-b pb-6">
        ...
        <p className="text-sm mt-2 text-muted-foreground">(This page can be printed or saved as a PDF using your browser's print function)</p>
      </header>
