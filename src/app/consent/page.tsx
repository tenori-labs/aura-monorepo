  ...
  const onSubmit = (data: ConsentFormValues) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description:
          'Your anti-ragging declaration has been recorded. A PDF copy is now available.',
      });
    ...
    return (
      <Card className="max-w-3xl mx-auto shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Thank you, {dummyStudent.name}. Your undertaking has been digitally signed and recorded.
          </CardDescription>
        </CardHeader>
        <CardContent className="text-center space-y-4">
          <p>
            A PDF copy of your signed declaration has been generated. You can download it for your
            records. A copy has also been sent to the college administration.
          </p>
  ...
  return (
    <Card className="max-w-3xl mx-auto shadow-xl">
      <CardHeader>
        ...
        <CardDescription>
          As per UGC regulations, all students and their parents must submit this undertaking at the
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-2 p-4 border rounded-lg bg-muted/30">
              ...
              <p className="text-sm">
                <strong>Name:</strong> {dummyStudent.name}
              </p>
              <p className="text-sm">
                <strong>Student ID:</strong> {dummyStudent.studentId}
              </p>
              <p className="text-sm">
                <strong>Course:</strong> {dummyStudent.course}
              </p>
            </div>
...
6) I hereby declare that I have not been expelled or debarred from admission in any institution in the country on account of being found guilty of, abetting or being part of a conspiracy to promote, ragging; and further affirm that, in case the declaration is found to be untrue, I am aware that my admission is liable to be cancelled.`}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel>
                        I confirm that my parent/guardian has also read and understood this
                        undertaking.
                      </FormLabel>
                      <FormDescription>
                        A separate undertaking from your parent/guardian may be required by the
                        institution.
                      </FormDescription>
                      <FormMessage />
                    </div>
            ...
            {/* Signature Pad */}
            <div>
              <Label htmlFor="signature-pad" className="text-base font-semibold">
                Digital Signature
              </Label>
              <div className="mt-2 p-4 border-2 border-dashed rounded-lg">
                <p className="text-sm text-muted-foreground mb-4">
                  Please type your full name in the box below to digitally sign this undertaking.
                  Your typed name will be considered your legal signature for this document.
                </p>
                <input
                  id="signature-pad"
                  type="text"
            ...
            >
              ...
              <AlertDescription className="text-blue-700 dark:text-blue-400">
                By clicking "Digitally Sign and Submit", I declare that the information provided is
                true and correct. I understand this is a legally binding document.
              </AlertDescription>
            </Alert>
